...
* When training the model, we refer to Fairway's attribute selection, which removes some inappropriate attributes, e.g., country. Therefore, in RQ1 (Figure 4), the total number of attributes we refer to is **the number after deletion**.
